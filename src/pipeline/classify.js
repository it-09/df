 ...
 */
export function classifySignals(allSignals, validCompanies, knownCompetitors) {
    // Deduplicate signals
    ...
    return uniqueSignals.map(signal => {
        ...
        }, signal.source, signal.subreddit || signal.sourceCategory, daysOld, noiseData.isNoise);
